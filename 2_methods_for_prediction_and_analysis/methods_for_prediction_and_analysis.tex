...
%\label{se:equations}
In order to compare the SI-method with data from roll decay model tests, methods to extract roll damping from tests and the SI-method are first examined. The roll moment along a longitudinal axis though the centre of gravity can be expressed according to \parencite{himeno_prediction_1981} by,
