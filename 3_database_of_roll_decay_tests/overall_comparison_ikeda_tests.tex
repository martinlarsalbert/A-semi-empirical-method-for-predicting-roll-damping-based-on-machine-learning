...
It was found that almost all ships in the roll damping database were outside the limits that are suitable to be applied in Eq.(\ref{eq:SI_limits}). 
...
Two different ways to handle this limit exceedance was investigated:
\begin{enumerate}
